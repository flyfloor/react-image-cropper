...
/******/ 	var hotCurrentHash = "a05b44508b677c27abbb"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentCropper = __webpack_require__(87);

	var _componentCropper2 = _interopRequireDefault(_componentCropper);

	var ImageCropDemo = (function (_React$Component) {
	    _inherits(ImageCropDemo, _React$Component);

	    function ImageCropDemo() {
	        _classCallCheck(this, ImageCropDemo);

	        _get(Object.getPrototypeOf(ImageCropDemo.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ImageCropDemo, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                null,
	                _react2['default'].createElement(_componentCropper2['default'], { src: 'http://braavos.me/images/posts/college-rock/the-smiths.png' })
	            );
	        }
	    }]);

	    return ImageCropDemo;
	})(_react2['default'].Component);

	exports.ImageCropDemo = ImageCropDemo;
