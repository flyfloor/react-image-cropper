...
/******/ 	var hotCurrentHash = "912ef48c446d1cc3a684"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _demoLess = __webpack_require__(163);

	var _demoLess2 = _interopRequireDefault(_demoLess);

	var _componentCropper = __webpack_require__(89);

	var _componentCropper2 = _interopRequireDefault(_componentCropper);

	var ImageCropDemo = _react2['default'].createClass({
	    displayName: 'ImageCropDemo',
	    ...
	    OnClick: function OnClick(state) {
	        var node = this.refs.cropper;
	        this.setState(_defineProperty({}, state, node.crop()));
	    },

	    handleMove: function handleMove(coords) {
	        var previewNode = _reactDom2['default'].findDOMNode(this.refs.previewNode);
	        var previewHolder = _reactDom2['default'].findDOMNode(this.refs.previewHolder);
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_componentCropper2['default'], { src: 'http://braavos.me/images/posts/college-rock/the-smiths.png', ref: 'cropper' }),
	                _react2['default'].createElement('br', null),
	                _react2['default'].createElement(
	                    'button',
	                    { onClick: function () {
	                            return _this.OnClick('image');
	                        } },
	                    'crop'
	                ),
	                _react2['default'].createElement(
	                ...
	                this.state.image ? _react2['default'].createElement('img', { width: '200', src: this.state.image, alt: '' }) : null
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cropper = _react2['default'].createClass({
	    ...
	    calcPosition: function calcPosition(width, height, left, top) {
	        ...
	        var cloneImg = _reactDom2['default'].findDOMNode(this.refs.cloneImg);
	    ...
	    handleDragStart: function handleDragStart(e) {
	        ...
	        if (!action) {
	            (function () {
	                var container = _reactDom2['default'].findDOMNode(_this3.refs.container);
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('img', { src: this.props.src, crossOrigin: true, ref: 'img', onLoad: this.imgOnload, width: this.state.img_width, height: this.state.img_height })
	            ),
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: '_clone' },
	                    _react2['default'].createElement('img', { src: this.props.src, crossOrigin: true, ref: 'cloneImg', width: this.state.img_width })
	                ),
	...
	Cropper.propTypes = {
	    ...
	    originX: _react2['default'].PropTypes.number,
	    originY: _react2['default'].PropTypes.number,
