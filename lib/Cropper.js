...
var Cropper = function (_Component) {
    ...
    _createClass(Cropper, [{
        ...
        key: 'calcPosition',
        value: function calcPosition(width, height, left, top) {
            var _state3 = this.state,
                imgWidth = _state3.imgWidth,
                imgHeight = _state3.imgHeight;
        ...
        value: function frameDotMove(dir, e) {
            ...
            var _state6 = this.state,
                ...
                frameWidth4Style = _state6.frameWidth4Style,
                frameHeight4Style = _state6.frameHeight4Style,
                frameWidth = _state6.frameWidth,
                frameHeight = _state6.frameHeight,
                imgWidth = _state6.imgWidth,
                imgHeight = _state6.imgHeight;
        ...
        value: function handleDragStart(e) {
            ...
            if (!action && allowNewSelection) {
                ...
                this.setState({
                    ...
                    return _this4.calcPosition(2, 2, pageX - offsetLeft, pageY - offsetTop);
                });
            }
        }
        ...
        value: function handleDragStop(e) {
            ...
            if (this.state.dragging) {
                ...
                this.setState({
                    ...
                    if (onChange) onChange(_this5.values());
                });
            }
        }
    }, {
