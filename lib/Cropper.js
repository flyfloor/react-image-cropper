...
var Cropper = React.createClass({
    ...
    render: function render() {
        ...
        var imageNode = React.createElement(
            ...
            React.createElement('img', { src: src, style: deepExtend({}, this.state.styles.img, this.state.styles.source_img), crossOrigin: true, ref: 'img',
        ...
        var node = disabled ? React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('img', { src: src, style: deepExtend({}, this.state.styles.img, {
                ...
                React.createElement('span', { className: '_move', style: this.state.styles.move, 'data-action': 'move' }),
                React.createElement(
                    'span',
                ...
                React.createElement(
                    ...
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotNE),
                        'data-action': 'ne' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerNE) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotN),
                        'data-action': 'n' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerN) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotNW),
                        'data-action': 'nw' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerNW) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotE),
                        'data-action': 'e' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerE) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotW),
                        'data-action': 'w' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerW) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotSE),
                        'data-action': 'se' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerSE) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotS),
                        'data-action': 's' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerS) })
                ),
                React.createElement(
                    'span',
                    { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotSW),
                        'data-action': 'sw' },
                    React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerSW) })
                ),
                React.createElement('span', { className: '_line _line-n', style: deepExtend({}, this.state.styles.line, this.state.styles.lineN),
                    'data-action': 'n' }),
                React.createElement('span', { className: '_line _line-s', style: deepExtend({}, this.state.styles.line, this.state.styles.lineS),
                    'data-action': 's' }),
                React.createElement('span', { className: '_line _line-w', style: deepExtend({}, this.state.styles.line, this.state.styles.lineW),
                    'data-action': 'w' }),
                React.createElement('span', { className: '_line _line-e', style: deepExtend({}, this.state.styles.line, this.state.styles.lineE),
                    'data-action': 'e' })
            )
        );
