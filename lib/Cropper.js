...
var Cropper = React.createClass({
    ...
    getInitialState: function getInitialState() {
        ...
        var selectionNatural = _props.selectionNatural;
        ...
        var beforeImageLoaded = _props.beforeImageLoaded;
    ...
    initStyles: function initStyles() {
        ...
        this.setState({
            ...
            var selectionNatural = _state.selectionNatural;
    ...
    imgGetSizeBeforeLoad: function imgGetSizeBeforeLoad() {
        ...
        setTimeout(function () {
            ...
            if (naturalWidth) {
                ...
                var frameWidth = _that$state.frameWidth;
                var frameHeight = _that$state.frameHeight;
                var originX = _that$state.originX;
                var originY = _that$state.originY;
                var img_width = _that$state.img_width;
                var img_height = _that$state.img_height;
                var beforeImageLoaded = _that$state.beforeImageLoaded;

                var _rateWidth = naturalWidth / img_width;
                var _rateHeight = naturalHeight / img_height;
                var realWidth = parseInt(frameWidth * _rateWidth);
                var realHeight = parseInt(frameHeight * _rateHeight);
                var realX = parseInt(originX * _rateHeight);
                var realY = parseInt(originY * _rateWidth);
    ...
    createNewFrame: function createNewFrame(e) {
        if (this.state.dragging) {
            ...
            var fixedRatio = _state4.fixedRatio;
    ...
    handleDragStart: function handleDragStart(e) {
        ...
        if (!action && allowNewSelection) {
            (function () {
                var container = ReactDOM.findDOMNode(_this2.refs.container);
    ...
    frameDotMove: function frameDotMove(dir, e) {
        ...
        var img_height = _state7.img_height;
        var fixedRatio = _state7.fixedRatio;
    ...
    values: function values() {
        ...
        var selectionNatural = _state9.selectionNatural;
    ...
    render: function render() {
        ...
        var imgLoaded = _state10.imgLoaded;
        ...
        var imageNode = React.createElement(
            ...
            React.createElement('img', { src: src, style: deepExtend({}, this.state.styles.img, this.state.styles.source_img), crossOrigin: true,
                ref: 'img',
            ...
            node = React.createElement(
                ...
                imgBeforeLoaded ? React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('span', { className: '_line _line-n',
                            style: deepExtend({}, this.state.styles.line, this.state.styles.lineN),
                            'data-action': 'n' }),
                        React.createElement('span', { className: '_line _line-s',
                            style: deepExtend({}, this.state.styles.line, this.state.styles.lineS),
                            'data-action': 's' }),
                        React.createElement('span', { className: '_line _line-w',
                            style: deepExtend({}, this.state.styles.line, this.state.styles.lineW),
                            'data-action': 'w' }),
                        React.createElement('span', { className: '_line _line-e',
