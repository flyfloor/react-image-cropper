...
var Cropper = React.createClass({
    ...
    updateFrame: function updateFrame(newWidth, newHeight, newOriginX, newOriginY) {
        ...
        this.setState({ frameWidth: newWidth, frameHeight: newHeight, originX: newOriginX, originY: newOriginY }, function () {
            _this2.initStyles();
        });
    },
    ...
    values: function values() {
        ...
        var moved = _state9.moved;
        var originalOriginX = _state9.originalOriginX;
        var originalOriginY = _state9.originalOriginY;
        var originalFrameWidth = _state9.originalFrameWidth;
        var originalFrameHeight = _state9.originalFrameHeight;
